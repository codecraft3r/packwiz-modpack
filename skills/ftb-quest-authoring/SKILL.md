...
9. Eligibility evidence: static analysis is acceptable proof that every visible quest is completable by at least one intended player; add a runtime check at the end of the project when reasonable.
